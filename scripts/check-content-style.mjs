...
// 注意：「網絡」「立即/馬上/趕快」「用戶」originally 也列在這裡，2026-08-13/
// 2026-09-02 對現有內容實測後陸續移到下方警告類——見 WARN_WORDS 裡的說明，
// 這是真的從實際內容裡發現的合法例外，不是理論假設。
const BANNED = [
...
const WARN_WORDS = [
  ...
  ['用戶', 'PAT-40原則上應改「使用者」，但2026-09-02健檢發現租屋板常見「水電用戶過戶」（Vertragsübernahme，指帳戶持有人變更）屬合法例外語境，是「帳戶持有人」義而非網站/服務「使用者」義——僅當指涉服務/系統的使用者時才需要改'],
