...
export const arrivalWorkflow: WorkflowTopic = {
  ...
  steps: [
    ...
    },
    {
      ...
      outcome: ['避免自動被歸入較貴的基本供電', '水費/垃圾費歸屬一次搞清楚'],
      detail: {
        ...
        procedure: [
          ...
          {
            text: '水費(Wasser)——通常不用辦：',
            items: [
              '1. 預設已包含在房租的 Nebenkosten 裡，房東統一處理',
              '2. 例外：你是屋主，或合約寫明由你負責，才需自行向當地 Wasserversorger 登記',
              '3. 不確定就直接問房東「水費是否含在 Nebenkosten 裡」',
            ],
          },
          {
            text: '垃圾費(Müllgebühr)——通常不用、也辦不了：',
            items: [
              '1. 預設已包含在 Nebenkosten 裡，垃圾桶由房東/管理公司統一登記',
              '2. 多數地區規定垃圾桶登記需屋主簽署，房客無法自行申請——垃圾桶不夠用等問題找房東，不要自己聯絡清潔隊',
              '3. 例外：你是屋主，才需自行向當地清潔隊(Abfallwirtschaftsbetrieb)登記，各城市自行搜尋辦理',
            ],
          },
        ],
        common_mistakes: [
        ...
        official_sources: [
          ...
          { name: 'umziehen.de · 水費登記說明', url: 'https://umziehen.de/an-ab-ummelden/wasser-anmelden-nach-dem-umzug-12230' },
        ],
      },
      references: [
